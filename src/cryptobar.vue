...
document.write(
  unescape(
    "%3Cscript src='js/jquery/jquery-2.2.4.min.js' type='text/javascript'%3E%3C/script%3E"
  )
);
document.write(
  unescape(
    "%3Cscript src='js/plugins.js' type='text/javascript'%3E%3C/script%3E"
  )
);
document.write(
  unescape(
...
.mainNav {
  background-color: #100b26 !important;
  display: flex;
  margin-left: 50vh;
  margin-right: 60vh;
  flex: 0 0 auto;
